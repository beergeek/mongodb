...
# @param encryption_keyfile_path The absolute path on the replica set nodes where the encryption-at-rest keyfile is located.
#   This is a common path for all nodes. Only required if `enable_encryption` is `true`.
# @param keytab_file_path The absolute path on the replica set nodes where the Kerberos keytab is located for the mongod service.
#   Only required if `enable_kerberos` is `true`.
# @param db_path The absolute path where the database files will be located. This path MUST exist prior to execution.
# @param inital_auto_agent_pwd An automatically generated password used as the initial password for the automation agent.
# @param inital_backup_agent_pwd An automatically generated password used as the initial password for the backup agent.
# @param inital_monitoring_agent_pwd An automatically generated password used as the initial password for the monitoring agent.
# @param log_file_path The absolute path and filename of the log file. This path MUST exist prior to execution.
# @param mongodb_version The MongoDB version to deploy, such as `4.0.9-ent` or `3.6.12-ent`.
